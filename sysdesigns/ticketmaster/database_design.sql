...
CREATE SEQUENCE IF NOT EXISTS performers_id_seq;
CREATE SEQUENCE IF NOT EXISTS event_performers_id_seq;
...
ALTER TABLE venues ADD CONSTRAINT venues_venue_id_fk FOREIGN KEY (id) REFERENCES events (venue_id);
