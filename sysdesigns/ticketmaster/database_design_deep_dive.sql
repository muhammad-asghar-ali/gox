CREATE TABLE IF NOT EXISTS discounts (
  ...
  discount_type varchar(500) NOT NULL,
...
ALTER TABLE events ADD CONSTRAINT events_discount_id_fk FOREIGN KEY (event_id) REFERENCES discounts (id);
...
ALTER TABLE users ADD CONSTRAINT users_organizer_id_fk FOREIGN KEY (id) REFERENCES events (organizer_id);
ALTER TABLE venues ADD CONSTRAINT venues_seat_venue_id_fk FOREIGN KEY (id) REFERENCES seats (venue_id);
ALTER TABLE venues ADD CONSTRAINT venues_event_venue_id_fk FOREIGN KEY (id) REFERENCES events (venue_id);
ALTER TABLE performers ADD CONSTRAINT performers_event_performer_fk FOREIGN KEY (id) REFERENCES event_performers (performer_id);
ALTER TABLE events ADD CONSTRAINT events_event_performer_fk FOREIGN KEY (id) REFERENCES event_performers (id);